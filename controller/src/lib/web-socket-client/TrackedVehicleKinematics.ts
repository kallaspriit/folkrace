...
export default class TrackedVehicleKinematics {
  public constructor(private options: TrackedVehicleOptions) {}
   ...
   */
  public calculateMotorSpeeds(speed: number, omega: number): MotorSpeeds {
  ...
  public getSpeedEncoderCount(speed: number) {
  ...
  public limit(speeds: MotorSpeeds, maxSpeed: number): MotorSpeeds {
  ...
  public getEncoderSpeeds(speeds: MotorSpeeds): MotorSpeeds {
    return {
