...
MadgwickAHRS::MadgwickAHRS(float gyroErrorDegS, float sampleFrequency)
{
  q0 = 1.0f;
  q1 = 0.0f;
  q2 = 0.0f;
  ...
  // calculated beta based on gyro error (given in degrees per second)
  float gyroErrorRadS = 3.14159265358979f * (gyroErrorDegS / 180.0f);

  beta = sqrt(3.0f / 4.0f) * gyroErrorRadS;
}
