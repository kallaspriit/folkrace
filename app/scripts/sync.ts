...
const fileMap: { [x: string]: string } = {
  "build/bundle.js": "../android/folkbot/src/main/res/raw/bundle.js",
  "build/main.css": "../android/folkbot/src/main/res/raw/main.css",
  "build/index.html": "../android/folkbot/src/main/res/raw/index.html"
};
...
function showError(error: Error, timeTaken: number) {
  ...
  process.stdout.write(
    `${chalk.bgRed.white(" FAIL ")} in ${chalk.bold(
      `${pad(timeTaken, 4)}ms`
    )}\n`
  );
